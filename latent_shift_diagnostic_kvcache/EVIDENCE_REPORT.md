...
- `latent_shift_diagnostic_kvcache/mask_true_recon_grid.png`
- `latent_shift_diagnostic_kvcache/mask_true_recon_union.png`
- `latent_shift_diagnostic_kvcache/mask_cfg_grid.png`
- `latent_shift_diagnostic_kvcache/mask_cfg_union.png`
- `latent_shift_diagnostic_kvcache/mask_nocfg_grid.png`
- `latent_shift_diagnostic_kvcache/mask_nocfg_union.png`
- `latent_shift_diagnostic_kvcache/generated_cfg.png`
- `latent_shift_diagnostic_kvcache/generated_nocfg.png`
